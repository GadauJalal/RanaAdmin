window.RANA_CONTROL_SEED = {
  ...
  installers: [
    { id: "INS-LAG-0084", name: "David Adeyemi", region: "Lagos", certification: "Current", capacity: "2 slots", phone: "+234 ••• ••74", activeJobs: 2, status: "Available" },
    { id: "INS-KAN-0022", name: "Maryam Bello", region: "Kano", certification: "Current", capacity: "1 slot", phone: "+234 ••• ••18", activeJobs: 3, status: "On job" },
    { id: "INS-ABJ-0046", name: "Emeka Nwosu", region: "Abuja", certification: "Expires in 12 days", capacity: "3 slots", phone: "+234 ••• ••41", activeJobs: 1, status: "Available" },
    { id: "INS-ACC-0011", name: "Kojo Tetteh", region: "Greater Accra", certification: "Current", capacity: "2 slots", phone: "+233 ••• ••09", activeJobs: 2, status: "Available" }
  ],
  jobs: [
    {
      id: "JOB-2608-0412",
      ...
      progress: 86,
      blockers: [],
      checklist: ["Owner confirmed", "Gateway linked", "Functions mapped", "Delivery test passed"],
    ...
    },
    {
      ...
      progress: 100,
      blockers: [],
      checklist: ["Owner confirmed", "Gateway linked", "Functions mapped", "Delivery test passed", "Installation accepted"],
  ...
  staff: [
    { id: "STF-OPS-010", name: "Lami Abdullahi", email: "l••••@rana54.com", role: "Platform Operator", scope: "All tenants", status: "Active", lastAccess: "6 min ago", privileged: true },
    { id: "STF-FLD-014", name: "Tunde Cole", email: "t••••@rana54.com", role: "Field Operations", scope: "Nigeria", status: "Active", lastAccess: "42 min ago", privileged: false },
    { id: "STF-DAT-009", name: "Zainab Ibrahim", email: "z••••@rana54.com", role: "Data Operations", scope: "All tenants", status: "Active", lastAccess: "2 hr ago", privileged: true },
    { id: "STF-SUP-021", name: "Kwame Asare", email: "k••••@rana54.com", role: "Support Analyst", scope: "Assigned tenants", status: "Active", lastAccess: "Yesterday", privileged: false }
  ],
  supportGrants: [
    { id: "GRANT-0418", staff: "Kwame Asare", enterprise: "Northbridge Retail", mode: "Read only", expires: "Today, 18:00", reason: "Investigate offline gateway", status: "Active" },
    { id: "GRANT-0411", staff: "Tunde Cole", enterprise: "Sahel Foods Ltd.", mode: "Read only", expires: "27 Aug, 17:00", reason: "Verify site acceptance", status: "Expired" }
  ],
  services: [
    { id: "SVC-RANAOS", name: "RanaOS ingestion", status: "Operational", metric: "99.98%", detail: "Live ingestion across active tenants" },
    { id: "SVC-FIELD", name: "Installer sync", status: "Operational", metric: "99.95%", detail: "Field queues are processing normally" },
    { id: "SVC-NOTIFY", name: "Notifications", status: "Operational", metric: "99.99%", detail: "Email and in-app delivery normal" },
    { id: "SVC-REPORTS", name: "Report generation", status: "Degraded", metric: "96.40%", detail: "Large exports are delayed by up to 18 minutes" }
  ],
  audit: [
    { id: "AUD-8821", time: "28 Aug, 12:48", actor: "System", action: "Delivery test recorded", entity: "GW-R54-KAN-7721", outcome: "Passed", reason: "Commissioning evidence received" },
    { id: "AUD-8820", time: "28 Aug, 12:41", actor: "Lami Abdullahi", action: "Incident acknowledged", entity: "INC-P2-2041", outcome: "Recorded", reason: "Device operations assigned" },
    { id: "AUD-8819", time: "28 Aug, 11:57", actor: "Tunde Cole", action: "Installation returned", entity: "JOB-2608-0398", outcome: "Blocked", reason: "Duplicate gateway serial" },
    { id: "AUD-8818", time: "28 Aug, 10:12", actor: "System", action: "Support grant expired", entity: "GRANT-0411", outcome: "Access removed", reason: "Scheduled expiry" },
    { id: "AUD-8817", time: "28 Aug, 09:16", actor: "Zainab Ibrahim", action: "Site request opened", entity: "REQ-SITE-1028", outcome: "Pending review", reason: "New enterprise request" }
  ]
};
